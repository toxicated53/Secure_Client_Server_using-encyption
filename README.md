...
## Overview
This Java Project demonstrates **Secure Client-Server Connection** with a **MITM Spy**. The goal is to show how encrypted messages can be exchanged between Client and Server even if a Spy (Third Person) is trying to Sniff the messages.
